...
SAVE_DIR = os.path.expanduser("~/water_cup/traj_tilt_only")
...
def main():
    ...
    move_lin((GRASP_X, CUP_POS[1], Z_LIFT), side, 120, FINGER_GRASP)
    move_lin_tilt((GRASP_X, 0.25, Z_LIFT), 210, FINGER_GRASP, tilt_deg=12.0, tilt_period=96)
    move_lin((GRASP_X, 0.25, GRASP_Z + 0.005), side, 120, FINGER_GRASP)
